...
export const api = {
  ...
  addWorkExperience: (id, payload) => request(`/candidates/${id}/work-experience`, { method: 'POST', body: JSON.stringify(payload) }),
  removeWorkExperience: (id, entryId) => request(`/candidates/${id}/work-experience/${entryId}`, { method: 'DELETE' }),
